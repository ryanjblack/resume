...
<div class="bg-white rounded-lg overflow-hidden border border-gray-400 p-4 text-xs">
  ...
  <div class="rounded flex items-center h-auto">
      ...
      <div class="flex-1 text-gray-700 text-center px-4 py-2 m-2"><a href="http://http://ryanjblack.io/outtatime/"><img class="m:auto" src="/assets/blog/preview/cartoonlorean.png" /><p>Fun</p></a></div>
  </div>
</div>
